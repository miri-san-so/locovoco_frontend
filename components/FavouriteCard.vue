<template>
    <div :class="this.type == 'list' ? 'card' : 'card-big ' + getClass(index)">
        <nuxt-link
        ...
        <button class="unfavourite" @click="unfavourite">
            <svg
                width="14"
                height="2"
                viewBox="0 0 14 2"
                ...
                xmlns="http://www.w3.org/2000/svg"
            >
                <path d="M0 1H13.5" stroke="#FF5757" stroke-width="2" />
            </svg>
        </button>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        async unfavourite() {
            this.$emit("unfavourite-user", this.content.phone_number);
            ...
            const URL = "http://172.105.42.84/producer/action/unfavourite";
            ...
            if (data.message == "Invalid Token") {
                ...
                this.$store.commit("unfav", this.content.phone_number);
            }
        }
    },
    mounted() {}
